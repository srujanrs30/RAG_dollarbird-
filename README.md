...
## step 1: 
download "website1.md" file.
## step 2: 
run the "chunking embedding and storing.ipynb" file - this will prepare the chunks, perform embeddings and store it inside vectordb.
## step 3: 
run "RAG without guardrails.ipynb" file to perform rag operation on the stored embeddings.
